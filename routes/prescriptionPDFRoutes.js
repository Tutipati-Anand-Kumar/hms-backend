 ...
 */
router.post("/upload-pdf", protect, upload.single("prescription"), async (req, res) => {
    try {
        if (!req.file) {
 ...
 * Requires authentication
 */
router.post("/upload-pdf-buffer", protect, async (req, res) => {
    try {
 ...
 * Requires authentication
 */
router.delete("/delete-pdf/:public_id", protect, async (req, res) => {
    try {
